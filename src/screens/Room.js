        ...
        if (isError == true) {
            ...
            return (
                <Container>
                    ...
                    {
                        this.props.room.room == '' && isLoadingData == false ?
                    ...
                    <Modal
                        ...
                        swipeDirection='down'
                        style={[styles.modal]}
                        onBackButtonPress={() => this.setState({ visibleModal: '' })}
                        ...
                        <View style={[styles.modalGeneral]}>
                            ...
                            <View style={{ justifyContent: 'space-between' }}>
                                <Left>
                                    <Button
                                        rounded={true}
                                        onPress={() => this.setState({ visibleModal: '' })}
                                        danger
                                        style={{ alignSelf: 'flex-start', left: -70 }}
                                    >
